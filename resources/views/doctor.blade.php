        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                ...
                <img class="logo-abbr" src="{{ asset('templet/images/logo.png') }}" alt="">
                <img class="logo-compact" src="{{ asset('templet/images/logo.png') }}" alt="">
                <img class="brand-title" src="{{ asset('templet/images/logo.png') }}" alt="">
            </a>
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('./images/logo.png') }}" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('templet/images/logo.png') }}" class="rounded-circle user_img" alt=""/>
